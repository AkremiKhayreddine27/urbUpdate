...
let rules = [
                ...
                options: {
                    name: path => {
                        if (! /node_modules|bower_components/.test(path)) {
                            return 'src/main/resources/static/images/[name].[ext]?[hash]';
                        }
...

    {
        ...
        options: {
            name: path => {
                if (! /node_modules|bower_components/.test(path)) {
                    return 'src/main/resources/static/fonts/[name].[ext]?[hash]';
                }

                return 'src/main/resources/static/fonts/vendor/' + path
                    .replace(/\\/g, '/')
                    .replace(
